...
// Define the default validation metadata object
const defaultValidationMetadata = {
  validation_id: 'unique-id-123',
  description: 'Checks for data integrity',
  category: 'DATA_LEVEL',
  sub_category: 'Sub Category Example',
  severity: 'CRITICAL',
    ...
    render(
      <ThemeProvider theme={{ ...DEFAULT_THEME }}>
        <Grid>
          ...
          <Row>
            <Col>
              <ValidationMetadata validationMetadata={defaultValidationMetadata} />
            </Col>
          </Row>
        </Grid>
      </ThemeProvider>,
